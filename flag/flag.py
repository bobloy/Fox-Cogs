...
class Flag:
    ...
    async def _list_flags(self, ctx, server, user):
        ...
        embed = discord.Embed(title="Flags for " + user.display_name, description="User has " + str(
            len(self.the_data[server.id]['flags'][user.id])) + " active flags", color=0x804040)
        ...
        if user.avatar_url is None:
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/icons/257557008662790145/dee9118e0048e5726cd0d27d37ddf4e4.jpg")
        else:
